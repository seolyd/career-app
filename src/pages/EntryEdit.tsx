        ...
        action={
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-[19px] font-medium text-blue-600 dark:text-blue-400"
            >
      ...
      <div className="space-y-5 p-4">
        ...
        {isDecision && (
          <section className="space-y-4 rounded-2xl border border-violet-200 bg-violet-50/60 p-4 dark:border-violet-900 dark:bg-violet-950/30">
            <h2 className="text-[19px] font-bold">Prediction — without this it is just a diary</h2>
            ...
            <div>
              ...
              <p className="mt-1 text-[16px] text-slate-700 dark:text-slate-400">
            ...
            {(reviewing || entry.verdict) && (
              <div className="space-y-4 border-t border-violet-200 pt-4 dark:border-violet-900">
                <h3 className="text-[19px] font-bold">Review</h3>
            ...
            <div className="border-t border-violet-200 pt-4 dark:border-violet-900">
              <div className="mb-2 flex items-center justify-between gap-2">
                <span className="text-[19px] font-bold">Build vs Buy</span>
        ...
        >
          ...
          <span>
            <span className="block text-[19px] font-medium">Publishable material</span>
            <span className="mt-0.5 block text-[17px] text-slate-700 dark:text-slate-400">
